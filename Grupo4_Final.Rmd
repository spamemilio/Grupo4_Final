...
### Analisis de la AUH respecto al Gasto Social financiado por el Presupuesto Nacional

Para continuar con el análisis vamos a utilizar el clasificador presupuestario por funcion. (llamado finalidad función)
...
Como vemos la AUH es casi la única función que ha ido creciendo en su peso respecto al gasto social. La mayoría de las demas funciones han decaído salvo algunas que se mantienen relativamente constantes. 
